    ...
    <AnimationComponent>
      <div className="displaydetailcard">
        ...
        <p className="courgette">
          ...
          <br />
          <br />
          <img src={DataCamp} alt="Data Camp" className="eduicon" />
          {' '}
          &nbsp; SQL & R from DataCamp
          <br />
          <img src={Udemy} alt="Udemy" className="eduicon" />
          {' '}
...
const AlmaBg = () => {
  return (
    <img src={EduBanner} className="width100 edubanner" alt="Edu Banner" />
  );
};
