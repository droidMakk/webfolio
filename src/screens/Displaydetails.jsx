...
import { Home, WhoAmI, AlmaMater, Social } from "../components/NavComponents";
import { NavTogglr } from "../components/common";
import { TopBar } from "../components";
import { Blogs, TimeLine, BlogPage, ListBlogs, Work } from "../screens";
...
export class Displaydetails extends Component {
	...
	focusHandler(ev) {
		document.getElementById("mainTogglr").addEventListener("focusout", () => {
	...
	toggleMainNav() {
		if (this.state.isNavOpen) {
			...
			document.querySelector("#mainTogglr > .navswitchHolder > .bottomArrow").style.transform =
				"translateY(-13px)";
